...
$(SYSLINUX_DIR)/.build: $(SYSLINUX_DIR)/.source
	...
	mkdir -p $(SYSLINUX_TARGET_DIR)/com32/menu
	...
	cp -a $(SYSLINUX_DIR)/com32/menu/vesamenu.c32 $(SYSLINUX_TARGET_DIR)/com32/menu
	cp -a $(SYSLINUX_DIR)/com32/menu/menu.c32 $(SYSLINUX_TARGET_DIR)/com32/menu

	cp -a $(SYSLINUX_DIR)/com32/hdt/hdt.c32 $(SYSLINUX_TARGET_DIR)/com32/menu
