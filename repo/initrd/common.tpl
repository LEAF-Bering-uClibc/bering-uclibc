<initrd-##ARCH##>
	...
	<Contents>
		...
		<File>
			Source		= lib/librt-0.9.33.2.so
			Filename	= lib/librt-0.9.33.2.so
			Type		= binary
			Permissions	= 644
		</File>
		<File>
			Filename	= lib/librt.so.0
			Target		= lib/librt-0.9.33.2.so
			Type		= link
		</File>
		<File>
			Source		= lib/libcrypt-0.9.33.2.so
			Filename	= lib/libcrypt-0.9.33.2.so
			Type		= binary
			Permissions	= 644
		</File>
		<File>
			Source		= lib/libuClibc-0.9.33.2.so
		...
		<File>
			...
			Target		= lib/libcrypt-0.9.33.2.so
			Type		= link
		</File>
		<File>
			Filename	= lib/ld-uClibc.so.0
			Target		= lib/ld-uClibc-0.9.33.2.so
			Type		= link
		</File>
		<File>
			Filename	= lib/libc.so.0
			Target		= lib/libuClibc-0.9.33.2.so
			Type		= link
		</File>
		<File>
