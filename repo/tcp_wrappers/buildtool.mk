...
MYLIB = -lnsl
export EXTRA_CFLAGS = -DSYS_ERRLIST_DEFINED -DHAVE_STRERROR -DHAVE_WEAKSYMS -D_REENTRANT -DINET6=1 -Dss_family=__ss_family -Dss_len=__ss_len
export COPTS = $(CFLAGS) -g
...
# Needs single-thread building due to poor makefile
	...
	cp -a $(TCP_WRAPPERS_DIR)/build-tree/tcp_wrappers_7.6/tcpd.h $(BT_TOOLCHAIN_DIR)/usr/include/
