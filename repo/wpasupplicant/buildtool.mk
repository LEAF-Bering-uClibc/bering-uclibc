...
.build: 
	...
	( cd $(SOURCE_DIR) ; export CFLAGS="$(BT_COPT_FLAGS) -MMD -Wall -g -I$(BT_STAGING_DIR)/usr/include" ; \
	export LIBS=-L$(BT_STAGING_DIR)/usr/lib ; make CC=$(TARGET_CC) ) ;
	-$(BT_STRIP) $(BT_STRIP_BINOPTS) $(SOURCE_DIR)/wpa_cli
	-$(BT_STRIP) $(BT_STRIP_BINOPTS) $(SOURCE_DIR)/wpa_passphrase
	-$(BT_STRIP) $(BT_STRIP_BINOPTS) $(SOURCE_DIR)/wpa_supplicant
