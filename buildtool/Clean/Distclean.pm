#$Id: Distclean.pm,v 1.1.1.1 2010/04/26 09:03:17 nitr0man Exp $
...
sub clean () {
      ...
      confess("buildtracedir not set in global config!") if (!$self->{'CONFIG'}{'buildtracedir'} or $self->{'CONFIG'}{'buildtracedir'} eq "");
